...
Use **pnpm** for all package commands. No npm. Check typsescript errors with `pnpm tsc --noEmit` or `pnpm build` (which also checks types). Check for setState linter errors as well.
