      ...
      <div className="hidden min-h-full w-full bg-slate-100 p-6 tablet:block tablet:p-7">
        ...
        <section className="mt-4 rounded-2xl bg-white p-5 ring-1 ring-slate-100">
          ...
          <div className="mt-3">
            ...
            <textarea className="mt-1 h-13 w-full resize-none rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-slate-300 focus:ring-1 focus:ring-slate-200" />
          </div>
